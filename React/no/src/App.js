    ...
    return (
      <div className="container">
        <div className='wrapper'>
          <div className='screen'>{input !== "" || input === "0" ? (<NumericFormat value={input} displayType={'text'} thousandSeperator={true} />) : (<NumericFormat value={preState} displayType={'text'} thousandSeperator={true} />)}</div>
